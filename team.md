...
<section class="section">
  ...
  <div class="team-profile-card">
    ...
    <div class="team-profile-copy">
      <p class="team-profile-bio">Peng Tan is a Professor and Principal Investigator at Hainan Academy of Medical Sciences, Hainan Medical University. His research focuses on innate immune sensing and region-specific neuroimmune interactions in the gut. He received his Ph.D. from Texas A&M University in 2018 and conducted off-campus research at Weill Cornell Medicine-Houston Campus (Houston Methodist Research Institute). He subsequently joined the Klarman Cell Observatory at the Broad Institute and HHMI at MIT as a postdoctoral associate under the mentorship of Aviv Regev and Ramnik Xavier. He is a recipient of the Student Research Fellowship and the IBD Plexus Award from the Crohn’s & Colitis Foundation of America, and serves as a team member of the Food Allergy Science Initiative and the Human Cell Atlas. Dr. Tan has authored more than 40 peer-reviewed publications, including first- and corresponding-author papers in journals such as Science, Nature Chemical Biology, Nucleic Acids Research, Molecular Cell, and Journal of Clinical Investigation. His work has received over 4,300 citations with an h-index of 30, and has been featured in multiple academic journals and media outlets.</p>
    </div>
  </div>
