...
<section class="section">
  ...
  <div class="team-profile-card">
    ...
    <div class="team-profile-copy">
      <p class="team-profile-bio">Peng Tan is a Professor and Principal Investigator at Hainan Academy of Medical Sciences, Hainan Medical University. His research focuses on mucosal immunity and functional genomics of the enteric nervous system. He received his Ph.D. from Texas A&M University-Weill Cornell Medical College joint program in 2018. He then joined the Klarman Cell Observatory at Broad Institute of MIT and Harvard, and HHMI at MIT as a postdoctoral associate under the mentorship of Aviv Regev and Ramnik Xavier. He is a recipient of Crohn’s & Colitis Foundation of America (CCFA) Student Research Fellowship, CCFA IBD Plexus Award, 2026 Harvard Chinese Life Science (HCLS) Distinguished Research Award, and serves as a team member of the Food Allergy Science Initiative and the Human Cell Atlas. Dr. Tan has authored more than 40 peer-reviewed publications, including first- and corresponding-author papers in journals such as Science, Nature Chemical Biology, Molecular Cell, Journal of Clinical Investigation, PLoS Biology, Nucleic Acids Research. His work has received over 4,400 citations with an h-index of 30, and has been featured in multiple academic journals and media outlets.</p>
    </div>
  </div>
